...
public class MainActivity extends AppCompatActivity {
  ...
  rv.setAdapter(adapter);
        ...
        myImagesViewModel.getAllImageList().observe(MainActivity.this, new Observer<List<MyImages>>() {
            @Override
    ...
    public void registerActivityForAddImages()
    {
    ...
    public void registerActivityForUpdateImage()
    {
        activityResultLauncherForUpdateImage=registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
            ...
            public void onActivityResult(ActivityResult result) {
                        ...
                        int  resultCode=result.getResultCode();//this is for knowing whether the user updates or not
                        Intent data=result.getData();
                        if(resultCode==RESULT_OK && data!=null)
                        {
